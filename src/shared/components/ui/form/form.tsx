...
>(({ className, ...props }, ref) => {
  ...
  return (
    <Label
      ref={ref}
      className={cn(error && "text-destructive", "text-sm text-zinc-600 dark:text-zinc-400", className)}
      htmlFor={formItemId}
      {...props}
    />
  );
  ...
  ({ className, children, ...props }, ref) => {
    ...
    return (
      <p
        ref={ref}
        id={formMessageId}
        className={cn("text-destructive text-[0.8rem] font-medium text-red-500", className)}
        {...props}
      >
        {body}
      </p>
